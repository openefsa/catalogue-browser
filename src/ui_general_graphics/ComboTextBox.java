...
/**
 * This class is used to use in the same way a text box and a combo box.
 * In particular, a text box is shown when the user is in ReadOnly mode, while
...
public class ComboTextBox {
	...
	/**
	 * Set the combo box selection. Used only in editing mode, the
	 * text box cannot use this function
	 * @param selection
	 */
	...
	/**
	 * Refreshes the combo box. it has effect only in editing mode
	 * the text box cannot be refreshed
	 */
