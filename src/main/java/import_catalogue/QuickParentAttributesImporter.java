...
public class QuickParentAttributesImporter extends QuickImporter {
	...
	InvalidFormatException, IOException, XMLStreamException {
		...
		this(new TermAttributeDAO(catalogue), 
				new ParentTermDAO(catalogue), catalogue, 
				workbookReader, termSheetName, batchSize);
	}
	
	public QuickParentAttributesImporter(
			CatalogueRelationDAO<TermAttribute, Term, Attribute> taDao, 
			CatalogueRelationDAO<Applicability, Term, Hierarchy> parentDao, 
			Catalogue catalogue, WorkbookReader workbookReader, 
			String termSheetName, int batchSize ) throws SQLException, 
	InvalidFormatException, IOException, XMLStreamException {
