...
/**
 * Interface for daos which are binary database relationships (we need additional parameters
 * to model them!)
 * @author avonva
 *
 * @param <E> the type of the relation entity
 * @param <A1> the type of the entity of one table involved in the relation
 * @param <A2> the type of the entity of the other table involved in the relation
 */
