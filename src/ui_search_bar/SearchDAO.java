...
public class SearchDAO {
	 ...
	 * @param hierarchies filter the results, only terms belonging to one of these hierarchies
	...
	/**
	 * Perform a search in the database terms and term attributes possibly filtering by hierarchies
	 * and term types (if present in the db)
	 * @param keywords set of keywords to be searched
	 * @param type the search method we want to use. See {@linkplain SearchType }
	...
	/**
	 * Check if the term type of the term is one of the
	...
	/**
	 * Check if the term has an applicable hierarchy which is contained 
	 * in the searchable hierarchies
	 * @param term
	...
	private ArrayList<Integer> findByAttribute ( ArrayList<String> keywords, 
		...
		// vector
		String query = "select distinct (TERM_ID) from APP.TERM_ATTRIBUTE where ATTR_ID in ( " 
	...
	/**
	 * Get the searchable attributes ids in a comma separated way
	 * in order to use them as a filter in the main query
	 * @return a string which contains the searchable attributes
	 * ids in a comma separated way. If no searchable attribute is
	...
	/**
	 * Select all the term attributes ids which match the keywords
	 * with the selected search metodology
	 * @param keywords
	 * @param type
	 * @return a string which contains the ids of the term attributes
	 ...
	 * combine the searches with ORs or ANDs.
