...
/**
 * Panel which contains the three tabs, which shows
 * term properties, applicabilities and implicit
 * facets. Implicit facets are permanently added and
 * removed from the db using this UI!
 * @author avonva
 *
 */
public class TermPropertiesPanel implements Observer {
	...
	private void addTermPropertyTab ( TabFolder parent ) {
		...
		compNames.setLayoutData( gridData );
	...
	private void addApplicabilityTab( TabFolder parent ) {
		...
		compApplicability.setLayoutData( gridData );
	...
	private void addFacetTab ( final TabFolder parent ) {
		...
		compImplicitFacets.setLayoutData( gridData );
	...
	/**
	 * Listener called when the properties of the
	 * term properties tab changed.
	...
	/**
	 * Listener called when an applicability is opened
	 * through the applicability tab
	 * @param openListener
	 */
	...
	/**
	 * Listener called when an applicability is added
	 * through the applicability tab
	 * @param addListener
	 */
	...
	/**
	 * Listener called when an applicability is removed
	 * through the applicability tab
	...
	/**
	 * Listener called when an applicability usability is
	 * changed through the applicability tab
	 * @param usageListener
	 */
	...
	/**
	 * Redraw the detail level and term type of the first tab 
	 * in order to adapt combobox or textbox based on edit mode or not
	 */
	public void redraw() {
		propTab.redraw();
	...
	public void refresh() {
		...
		boolean editMode = catalogue != null 
				&& user.canEdit( catalogue );
